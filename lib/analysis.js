...
import { isFirecrawlExtractEnabled, extractCatalogueNative, extractPaginatedCatalogue, extractTwoPass, parseJohnPyeLotCard } from './pipeline/firecrawl-extract.js';
import {
...
async function autoAnalyseOne(url) {
  ...
  const TWO_PASS_HOUSES = {
    ...
    johnpye: {
      maxPages: 1,
      detailUrlPattern: /\/auctions\/([\w-]+)/g,
      buildDetailUrl: (slug) => `https://www.johnpye.co.uk/auctions/${slug}/`,
      parseLotFromMarkdown: parseJohnPyeLotCard,
    },
  };
