...
export const EXTRACTION_PROFILE = {
  ...
  // fssproperty kept as-is for now: HOUSE_ROOTS points at a broken live-stream
  // URL with no lots, so a recogniser can't help until the URL is fixed. Track
  // separately via auction-self-healing (Category B sweep).
