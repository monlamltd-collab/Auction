...
export const HOUSE_ROOTS = {
  ...
  '247propertyauctions':  'https://247propertyauctions.eigonlineauctions.com/search',
...
export function detectAuctionHouse(url) {
  ...
  // ── EIG houses from discovery (April 2026) ──
  if (u.includes('247propertyauctions.eigonlineauctions')) return '247propertyauctions';
