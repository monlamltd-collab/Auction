...
export const AUCTION_DISCOVERY = {
  // ── Query-string ?auction=N pattern (Maggs & similar CMSes) ──
  maggsandallen: {
  ...
  hollismorgan: {
    ...
    // Hollis uses the same CMS family as Maggs but URL scheme may differ — AI handles it
  },
  buttersjohnbee: {
...
export async function rewriteUrl(url, house) {
  ...
  // Stags / GTH: Homeflow SPA — needs JS rendering + extended wait for SPA hydration.
