...
export const AUCTION_DISCOVERY = {
  ...
  // ── Intermittent 503 + staff-photo page glitch (Charles Darrow) ──
  // Added 2026-04-24 after audit caught the 503. Watcher will find the
  // correct catalogue URL on retry if the listing page moves.
  charlesdarrow: {
    homepage: 'https://www.charlesdarrow.co.uk/',
  },
};
