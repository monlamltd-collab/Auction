...
export const LOT_COLUMNS = Object.freeze([
  ...
  'house',   // logical key; physical column renamed to house_slug (Phase 2a) — aliased in LOTS_SELECT below
  'auctioneer',
  'lot_number',
  'url',
  'catalogue_url',
...
// it here as 'logicalKey:physical_column'. Phase 2a renamed lots.house ->
// house_slug; this alias keeps the returned JSON key `house`, so no consumer —
// nor the LOT_COLUMNS contract test (tests/test-lot-columns.js) — has to change.
