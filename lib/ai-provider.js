...
async function callOpenRouterProvider(prompt, model, maxTokens, systemPrompt) {
  ...
  // the provider-level cascade in callAI.
  const backups = (process.env.OPENROUTER_FALLBACK_MODELS || '')
