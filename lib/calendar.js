...
export const FALLBACK_CALENDAR = [
    ...
    // ── Sheffield independent (own catalogue, NOT BTG/SDL) ──
    { house: 'Mark Jenkinson', houseSlug: 'markjenkinson', logo: '🔨', date: '2099-12-31', title: 'Current Catalogue', lots: null, url: 'https://www.markjenkinson.co.uk/property-search', location: 'Sheffield (Online)', type: 'Residential & Commercial', status: 'always_on', catalogueReady: true },
    // ── SDL platform houses ──
