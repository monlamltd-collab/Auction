...
// Tunables. Old SWEEP_BATCH_LIMIT=50 meant ~213-day backlog at the
// 10,693-active-lot scale — the gallery feature was effectively dead in
// the water. Wall-clock budget is the real constraint (most fetches are
// free HTTP, only Firecrawl-fallback costs a credit). 30 minutes covers
// ~600 lots/run at 3s/lot — clears the backlog in 2-3 weeks.
const SWEEP_BATCH_LIMIT = 1000;            // soft ceiling — wall-clock is the actual guard
const SWEEP_FETCH_POOL = 5000;             // pull this many candidate rows from the DB
