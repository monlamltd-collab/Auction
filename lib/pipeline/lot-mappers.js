...
// Note: lots.images JSONB column exists (migration 2026-04-27-coverage-fix)
// but is intentionally not selected — fix #5 from COVERAGE_FIX_PLAN.md is held
// until the gallery feature ships. Add 'images' to the SELECT and the mappers
// in the same PR that renders it.
export const LOTS_SELECT = 'house, lot_number, url, catalogue_url, address, postcode, lat, lng, price, price_text, price_status, prop_type, beds, tenure, lease_length, sqft, condition, image_url, bullets, units, auction_date, status, sold_price, epc_rating, epc_score, epc_date, epc_floor_area_sqm, epc_floor_area_sqft, flood_zone, flood_risk, street_avg, street_sales, street_sales_count, below_market, est_monthly_rent, est_annual_rent, est_gross_yield, score, score_breakdown, opps, risks, deal_type, vacant, title_split, search_text, enrichment_manifest, last_seen_at, quality_score, quality_issues';
