// lib/pipeline/index.js — Public API for the modular pipeline
...
export { extractPriceFromText, runEnrichmentWave, drainHygieneRetries } from './enrichment-wave.js';
export { createDbRowToLot, dbRowToFrontendLot, LOTS_SELECT } from './lot-mappers.js';
export { computeScrapeDiff } from './scrape-diff.js';
export { logActivityEvent } from './activity-log.js';
