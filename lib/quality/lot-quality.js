...
// Effective price status for in-memory pipeline lots: the persisted
// priceStatus when present, else derived on the spot. Without this, the
// computeBatchCoverage call sites (persist-stage, parity-gate) — which see
// raw pipeline lots that never carried priceStatus — silently counted
// nil_reserve/POA lots as price gaps (review 2026-06-12 #4).
