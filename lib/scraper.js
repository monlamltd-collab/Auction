...
export {
  ...
  scrapeWithPuppeteer, hasPuppeteer,
...
export {
  scrapeSymondsAndSampson,
} from './scraper/symondsandsampson.js';

export {
  scrapeUnderTheHammer, UTH_CATALOGUE_URL,
} from './scraper/underthehammer.js';

export {
  scrapePattinson, PATTINSON_CATALOGUE_URL,
} from './scraper/pattinson.js';
