...
import { DOM_EXTRACTORS, UNIVERSAL_DOM_EXTRACTOR, extractWithJSDOM, setLastExtractorUsed } from './extractors.js';
...
export function initScraper({ callAI, getCreditExhausted, setCreditExhausted, setCreditExhaustedAt, getApiCallCount, incApiCallCount, extractPostcode }) {
  _callAI = callAI;
...
export const FIRECRAWL_SKIP = new Set((process.env.FIRECRAWL_SKIP_HOUSES || '').split(',').filter(Boolean));
let _fcLastCall = 0;
...
export function getFcCreditsUsed() { return fcCreditsUsed; }
export function isFcCreditExhausted() { return fcCreditExhausted; }
export function getFcExhaustedAt() { return fcExhaustedAt; }
export function getFcFallbackCount() { return fcFallbackCount; }
export function getFcErrorCount() { return fcErrorCount; }
export function getFcRequestCount() { return fcRequestCount; }
export function isFcTemporarilyDown() { return fcTemporarilyDown; }
export function getFcDownAt() { return fcDownAt; }
export function getFcConsecutive5xx() { return fcConsecutive5xx; }
export function getFcLastError() { return fcLastError; }
export function getFcLastErrorAt() { return fcLastErrorAt; }
export function setFcCreditExhausted(v) { fcCreditExhausted = v; }
export function setFcExhaustedAt(v) { fcExhaustedAt = v; }
export function setFcCreditsUsed(v) { fcCreditsUsed = v; }
export function setFcTemporarilyDown(v) { fcTemporarilyDown = v; }
export function setFcDownAt(v) { fcDownAt = v; }
export function setFcConsecutive5xx(v) { fcConsecutive5xx = v; }

export function getFirecrawlStatus() {
  return {
    creditsUsed: fcCreditsUsed,
    creditExhausted: fcCreditExhausted,
    exhaustedAt: fcExhaustedAt,
    fallbackCount: fcFallbackCount,
    errorCount: fcErrorCount,
    requestCount: fcRequestCount,
    temporarilyDown: fcTemporarilyDown,
    downAt: fcDownAt,
    consecutive5xx: fcConsecutive5xx,
    lastError: fcLastError,
    lastErrorAt: fcLastErrorAt,
...
// ═══════════════════════════════════════════════════════════════
export async function fetchLotPage(url) {
...
// ═══════════════════════════════════════════════════════════════
export async function enrichLotsFromLotPages(lots, concurrency = 5) {
