...
// Prompt to pass alongside CATALOGUE_SCHEMA. Critical for high-recall extraction
// of long lists. Without this, the LLM under-extracts ~50% of cards.
export const CATALOGUE_PROMPT =
  ...
  'For each lot, fill every field that is visible on the card. Return null for fields that are not present on this card. ' +
  'Lot status values: available | sold | withdrawn | postponed. ' +
  'Treat every distinct property card on the page as a separate lot — do not merge or de-duplicate.';
