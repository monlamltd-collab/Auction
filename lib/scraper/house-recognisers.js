...
export const HOUSE_RECOGNISERS = {
  ...
  sdl: { maxPages: 1, recallSentinelPattern: /btgeddisonspropertyauctions\.com\/properties\/([a-z0-9_-]+?)\/for-auction/gi, recogniseFromMarkdown: recogniseBtgEddisonsLotsFromMarkdown },
};
