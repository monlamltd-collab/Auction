# Visual Audit — 2026-05-03

Scanned **11,806** rows in **7910ms** across **72** houses with findings.

**Findings:** 514 error · 19 warn · 50 info
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 59 addresses appear ≥3 times each (213 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":59,"total_dupe_rows":213,"examples":[{"address":"whitehall road, whitehall, bs5 9bj","count":3},{"address":"anstey street, easton, bs5 6dg","count":3},{"address":"argyle street, gorse hill, sn2 8ar","count":3}]}`
...
- **[info] stale_lot_wall** — Stale lot wall: 23/34 (68%) lots are past auction date >7d but still marked available
  - `{"stale":23,"total":34,"ratio":0.676,"cutoff":"2026-04-26T07:14:00.594Z"}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 157 addresses appear ≥3 times each (548 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":157,"total_dupe_rows":548,"examples":[{"address":"8 coedwig terrace, penmon, beaumaris, anglesey, ll58 8sl","count":4},{"address":"trem y dyffryn, llanbedr-y-cennin, conwy, gwynedd, ll32 8un","count":4},{"address":"8 llwyn onn, rhos on sea, colwyn bay, conwy, ll28 4bz","count":4}]}`
