# Visual Audit — 2026-07-18

Scanned **32,322** rows in **26299ms** across **40** houses with findings.
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 703/925 (76%) lots have no price + no price_text
  - `{"tba":703,"total":925,"ratio":0.76}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 368/369 (100%) lots use host 'www.auctionhouse.co.uk' — could be a logo/placeholder
  - `{"host":"www.auctionhouse.co.uk","count":368,"total":369,"ratio":0.997}`
...
- **[info] bullet_starvation** — Bullet starvation: 740/950 (78%) lots have empty bullets
  - `{"empty":740,"total":950,"ratio":0.779}`
...
- **[warn] image_coverage_low** — Image coverage low: 1932/3161 (61%) lots missing image_url
  - `{"missing":1932,"total":3161,"ratio":0.611}`
