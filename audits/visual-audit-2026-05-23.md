# Visual Audit — 2026-05-23

Scanned **16,232** rows in **11292ms** across **65** houses with findings.

**Findings:** 38 error · 14 warn · 38 info

## acuitus

- **[info] bullet_starvation** — Bullet starvation: 62/64 (97%) lots have empty bullets
  - `{"empty":62,"total":64,"ratio":0.969}`
...
- **[info] bullet_starvation** — Bullet starvation: 48/55 (87%) lots have empty bullets
  - `{"empty":48,"total":55,"ratio":0.873}`
...
- **[info] bullet_starvation** — Bullet starvation: 71/90 (79%) lots have empty bullets
  - `{"empty":71,"total":90,"ratio":0.789}`
...
- **[info] bullet_starvation** — Bullet starvation: 51/51 (100%) lots have empty bullets
  - `{"empty":51,"total":51,"ratio":1}`
...
- **[info] bullet_starvation** — Bullet starvation: 58/67 (87%) lots have empty bullets
  - `{"empty":58,"total":67,"ratio":0.866}`
...
- **[info] stale_lot_wall** — Stale lot wall: 8/8 (100%) lots are past auction date >7d but still marked available
  - `{"stale":8,"total":8,"ratio":1,"cutoff":"2026-05-16T07:25:28.866Z"}`
...
- **[error] hero_image_bleed** — Hero-image bleed: 11 distinct addresses share one image_url
  - `{"image_url":"https://s3.eu-west-2.amazonaws.com/app-spoke-sites-qa-uk/134/3d947c64249de3f3e029c5bd31205024.png","distinct_addresses":11}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 3 addresses appear ≥3 times each (12 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":3,"total_dupe_rows":12,"examples":[{"address":"dover - kent","count":4},{"address":"andover - hampshire","count":5},{"address":"freehold parcel of land","count":3}]}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 294/294 (100%) lots use host 'www.futurepropertyauctions.co.uk' — could be a logo/placeholder
  - `{"host":"www.futurepropertyauctions.co.uk","count":294,"total":294,"ratio":1}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 9 addresses appear ≥3 times each (37 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":9,"total_dupe_rows":37,"examples":[{"address":"bell hill, stapleton, bs16 1bq","count":3},{"address":"nags head hill, hanham, bs5 8ln","count":3},{"address":"fountain buildings, walcot, ba1 5du","count":5}]}`

## hunters

- **[warn] image_coverage_low** — Image coverage low: 20/22 (91%) lots missing image_url
  - `{"missing":20,"total":22,"ratio":0.909}`
...
- **hero_image_bleed**: nulled 32 row(s) across 1 house(s).
  - `buttersjohnbee` × 32 — `https://s3.eu-west-2.amazonaws.com/app-spoke-sites-qa-uk/134/3d947c64249de3f3e029c5bd31205024.png`
