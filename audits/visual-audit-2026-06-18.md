# Visual Audit — 2026-06-18

Scanned **25,825** rows in **15630ms** across **80** houses with findings.

**Findings:** 66 error · 13 warn · 23 info
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 10 addresses appear ≥3 times each (31 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":10,"total_dupe_rows":31,"examples":[{"address":"4 north road, kirkby stephen, cumbria ca17 4rh","count":3},{"address":"5 tarn head, haverigg, millom, cumbria la18 4ne","count":3},{"address":"24 beech street, barrow-in-furness, cumbria la14 5eb","count":3}]}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 14 addresses appear ≥3 times each (43 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":14,"total_dupe_rows":43,"examples":[{"address":"17 bairstow street, blackpool, lancashire, fy1 5bn","count":3},{"address":"15 bairstow street, blackpool, lancashire, fy1 5bn","count":3},{"address":"2 green lane, bishop auckland, county durham, dl14 6rs","count":3}]}`
- **[warn] guide_tba_wall** — Guide-TBA wall: 806/967 (83%) lots have no price + no price_text
  - `{"tba":806,"total":967,"ratio":0.834}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 259/260 (100%) lots use host 'www.auctionhouse.co.uk' — could be a logo/placeholder
  - `{"host":"www.auctionhouse.co.uk","count":259,"total":260,"ratio":0.996}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 14 addresses appear ≥3 times each (47 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":14,"total_dupe_rows":47,"examples":[{"address":"freehold ground rent interest 12 sandringham road, southport, merseyside, pr8 2jz","count":3},{"address":"no. 2 woodland east of tunstall road, congleton, cheshire, cw12 3qa","count":3},{"address":"51 co-operative street goldthorpe, rotherham, south yorkshire, s63 9hn","count":3}]}`
- **[warn] guide_tba_wall** — Guide-TBA wall: 1501/1589 (94%) lots have no price + no price_text
  - `{"tba":1501,"total":1589,"ratio":0.945}`

## auctionhouseteesvalley

- **[error] duplicate_address_wall** — Duplicate-address wall: 3 addresses appear ≥3 times each (10 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":3,"total_dupe_rows":10,"examples":[{"address":"93 broadway east, redcar, north yorkshire ts10 5dt","count":4},{"address":"richards house , crosby road, northallerton dl6 1ae","count":3},{"address":"100l westgate, guisborough, north yorkshire ts14 6ap","count":3}]}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 26 addresses appear ≥3 times each (78 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":26,"total_dupe_rows":78,"examples":[{"address":"10 town hall street, grimsby, north east lincolnshire, dn31 1hn","count":3},{"address":"220a hornchurch road, hornchurch, essex, rm11 1qj","count":3},{"address":"32 cumberland drive, chessington, surrey, kt9 1hq","count":3}]}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 5 addresses appear ≥3 times each (17 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":5,"total_dupe_rows":17,"examples":[{"address":"flat 4, 7 oriental place, brighton, bn1 2lj","count":3},{"address":"flat 3, 40 tivoli crescent, brighton, bn1 5nd","count":3},{"address":"53 dominica court, eastbourne, bn23 5tr","count":3}]}`
- **[info] image_domain_mismatch** — Image domain mismatch: 109/119 (92%) lots use host 'www.auctionhouse.co.uk' — could be a logo/placeholder
  - `{"host":"www.auctionhouse.co.uk","count":109,"total":119,"ratio":0.916}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 458/460 (100%) lots use host 'www.futurepropertyauctions.co.uk' — could be a logo/placeholder
  - `{"host":"www.futurepropertyauctions.co.uk","count":458,"total":460,"ratio":0.996}`
...
- **[warn] image_coverage_low** — Image coverage low: 52/79 (66%) lots missing image_url
  - `{"missing":52,"total":79,"ratio":0.658}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 3 addresses appear ≥3 times each (10 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":3,"total_dupe_rows":10,"examples":[{"address":"the knot barn, 1 station road, padstow, cornwall, pl28 8db","count":4},{"address":"51 margravine road, london, w6 8ll","count":3},{"address":"77-81 alma road, clifton, bristol, bs8 2dp","count":3}]}`
