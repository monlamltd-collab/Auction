...
Scanned **34,087** rows in **28333ms** across **35** houses with findings.

**Findings:** 14 error · 12 warn · 21 info
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 1544/1672 (92%) lots have no price + no price_text
  - `{"tba":1544,"total":1672,"ratio":0.923}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 4 visible addresses appear ≥3 times each (20 rows users can see) — stale re-list rows, URL variants, or venue extraction
  - `{"unique_dupes":4,"total_dupe_rows":20,"examples":[{"address":"dulverton - somerset","count":8},{"address":"maidstone - kent","count":4},{"address":"dover - kent","count":5}]}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 1170/1171 (100%) lots use host 'www.futurepropertyauctions.co.uk' — could be a logo/placeholder
  - `{"host":"www.futurepropertyauctions.co.uk","count":1170,"total":1171,"ratio":0.999}`
...
- **[warn] image_coverage_low** — Image coverage low: 235/399 (59%) lots missing image_url
  - `{"missing":235,"total":399,"ratio":0.589}`
- **[info] bullet_starvation** — Bullet starvation: 303/399 (76%) lots have empty bullets
  - `{"empty":303,"total":399,"ratio":0.759}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 1 visible addresses appear ≥3 times each (58 rows users can see) — stale re-list rows, URL variants, or venue extraction
  - `{"unique_dupes":1,"total_dupe_rows":58,"examples":[{"address":"261 barlow moor road, manchester, lancashire, m21 7gj","count":58}]}`
