...
Scanned **35,714** rows in **34270ms** across **11** houses with findings.

**Findings:** 7 error · 1 warn · 6 info
...
- **[info] bullet_starvation** — Content starvation: 21/22 (95%) lots have neither usable bullets nor a meaningful description
  - `{"empty":21,"total":22,"ratio":0.955}`
