...
Scanned **11,405** rows in **12881ms** across **70** houses with findings.
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 6 addresses appear ≥3 times each (19 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":6,"total_dupe_rows":19,"examples":[{"address":"national online auction bidding now open! click to view lots","count":4},{"address":"99 marfleet avenue, hull, east yorkshire, hu9 5sb","count":3},{"address":"35 orient court gresley close, telford, shropshire, tf7 5tu","count":3}]}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 4 addresses appear ≥3 times each (33 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":4,"total_dupe_rows":33,"examples":[{"address":"virtual viewing","count":22},{"address":"clough road, droylsden, greater manchester, m43","count":4},{"address":"zodiac drive, stoke on trent, staffordshire, st6","count":3}]}`
- **[info] bullet_starvation** — Bullet starvation: 283/284 (100%) lots have empty bullets
  - `{"empty":283,"total":284,"ratio":0.996}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 164/167 (98%) lots use host 'www.futurepropertyauctions.co.uk' — could be a logo/placeholder
  - `{"host":"www.futurepropertyauctions.co.uk","count":164,"total":167,"ratio":0.982}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 63 addresses appear ≥3 times each (229 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":63,"total_dupe_rows":229,"examples":[{"address":"bell hill, stapleton, bs16 1bq","count":3},{"address":"whitehall road, whitehall, bs5 9bj","count":3},{"address":"drake avenue, combe down, ba2 5nx","count":3}]}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 9 addresses appear ≥3 times each (36 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":9,"total_dupe_rows":36,"examples":[{"address":"st. ive, liskeard, cornwall pl14","count":4},{"address":"bolventor, launceston, cornwall pl15","count":4},{"address":"victoria road, camelford, cornwall pl32","count":4}]}`

## knightfrank

- **[info] bullet_starvation** — Bullet starvation: 22/22 (100%) lots have empty bullets
  - `{"empty":22,"total":22,"ratio":1}`

## landwood

- **[warn] image_coverage_low** — Image coverage low: 93/132 (70%) lots missing image_url
  - `{"missing":93,"total":132,"ratio":0.705}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 58 addresses appear ≥3 times each (199 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":58,"total_dupe_rows":199,"examples":[{"address":"former ynysgau chapel, wyndham street, merthyr tydfil, merthyr tydfil, cf48 4jy","count":4},{"address":"49 commercial street, mountain ash, cf45 3ps","count":3},{"address":"clomendy farm, commercial street, cwmbran, gwent, np44 3lr","count":4}]}`
...
- **[info] stale_lot_wall** — Stale lot wall: 23/34 (68%) lots are past auction date >7d but still marked available
  - `{"stale":23,"total":34,"ratio":0.676,"cutoff":"2026-04-24T19:00:48.714Z"}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 147 addresses appear ≥3 times each (489 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":147,"total_dupe_rows":489,"examples":[{"address":"8 coedwig terrace, penmon, beaumaris, anglesey, ll58 8sl","count":4},{"address":"trem y dyffryn, llanbedr-y-cennin, conwy, gwynedd, ll32 8un","count":4},{"address":"8 llwyn onn, rhos on sea, colwyn bay, conwy, ll28 4bz","count":4}]}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 20 addresses appear ≥3 times each (67 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":20,"total_dupe_rows":67,"examples":[{"address":"apt. 10 justine mansions 4 riding street, liverpool, l3 5np","count":4},{"address":"15 spellow lane, liverpool, l4 4de","count":3},{"address":"19 spellow lane, liverpool, l4 4de","count":3}]}`
