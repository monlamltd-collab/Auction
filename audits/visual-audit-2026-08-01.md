# Visual Audit — 2026-08-01

Scanned **35,411** rows in **36218ms** across **13** houses with findings.

**Findings:** 6 error · 2 warn · 6 info
...
- **[warn] image_coverage_low** — Image coverage low: 31/32 (97%) lots missing image_url
  - `{"missing":31,"total":32,"ratio":0.969}`
