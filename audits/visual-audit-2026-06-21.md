# Visual Audit — 2026-06-21

Scanned **25,972** rows in **17074ms** across **78** houses with findings.

**Findings:** 67 error · 10 warn · 22 info
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 14 addresses appear ≥3 times each (43 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":14,"total_dupe_rows":43,"examples":[{"address":"room 20, salem street student accomodation salem street, hallgate, bradford, west yorkshire, bd1 4qd","count":3},{"address":"82 hartington road, stockton-on-tees, cleveland, ts18 1he","count":3},{"address":"15 jackson street goldthorpe, rotherham, south yorkshire, s63 9lp","count":3}]}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 59 addresses appear ≥3 times each (194 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":59,"total_dupe_rows":194,"examples":[{"address":"flat 36 meriden court, chelsea manor street, chelsea, london, sw3 3tt","count":3},{"address":"33 brislington hill, bristol, avon, bs4 5be","count":3},{"address":"portage, holbeach drove gate, holbeach drove, spalding, lincolnshire, pe12 0px","count":4}]}`
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 334/454 (74%) lots have no price + no price_text
  - `{"tba":334,"total":454,"ratio":0.736}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 31 addresses appear ≥3 times each (106 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":31,"total_dupe_rows":106,"examples":[{"address":"plots at burnside cottages, aberdeen, aberdeenshire ab12 5yq","count":4},{"address":"2 cnoc mhor, balvicar, oban, argyll pa34 4tg","count":4},{"address":"land at ladysbridge cottages, banff, banffshire ab45 2jr","count":5}]}`
- **[info] image_domain_mismatch** — Image domain mismatch: 267/270 (99%) lots use host 'www.auctionhouse.co.uk' — could be a logo/placeholder
  - `{"host":"www.auctionhouse.co.uk","count":267,"total":270,"ratio":0.989}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 30 addresses appear ≥3 times each (91 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":30,"total_dupe_rows":91,"examples":[{"address":"land to the east of arthur street, crook, county durham, dl15 9du","count":3},{"address":"land to the north and west of 19 filgrave, newport pagnell, buckinghamshire, mk16 9et","count":3},{"address":"land at manor end, lower luton road, wheathampstead, st. albans, hertfordshire, al4 8jh","count":3}]}`

## auctionhousewales

- **[error] duplicate_address_wall** — Duplicate-address wall: 2 addresses appear ≥3 times each (6 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":2,"total_dupe_rows":6,"examples":[{"address":"46 fairfield road queensferry, deeside, flintshire, ch5 1ss","count":3},{"address":"32 bentley street farnworth, bolton, lancashire, bl4 7pw","count":3}]}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 4 addresses appear ≥3 times each (14 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":4,"total_dupe_rows":14,"examples":[{"address":"flat 4, 7 oriental place, brighton, bn1 2lj","count":3},{"address":"1 regents close, hayes, middlesex, ub4 8jy","count":4},{"address":"flat 3, 40 tivoli crescent, brighton, bn1 5nd","count":3}]}`
...
- **[info] bullet_starvation** — Bullet starvation: 51/54 (94%) lots have empty bullets
  - `{"empty":51,"total":54,"ratio":0.944}`
...
- **[warn] image_coverage_low** — Image coverage low: 504/838 (60%) lots missing image_url
  - `{"missing":504,"total":838,"ratio":0.601}`
