# Visual Audit — 2026-07-13

Scanned **31,348** rows in **28982ms** across **39** houses with findings.

**Findings:** 17 error · 12 warn · 21 info
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 3 visible addresses appear ≥3 times each (9 rows users can see) — stale re-list rows, URL variants, or venue extraction
  - `{"unique_dupes":3,"total_dupe_rows":9,"examples":[{"address":"38 aubries walkern, stevenage, hertfordshire, sg2 7nj","count":3},{"address":"5a market place, halesworth, suffolk ip19 8ba","count":3},{"address":"flat 11, lilystone hall, honeypot lane, stock, ingatestone, essex cm4 9gj","count":3}]}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 17/18 (94%) lots use host 'www.auctionhouse.co.uk' — could be a logo/placeholder
  - `{"host":"www.auctionhouse.co.uk","count":17,"total":18,"ratio":0.944}`

## auctionhouselincolnshire

- **[warn] guide_tba_wall** — Guide-TBA wall: 694/904 (77%) lots have no price + no price_text
  - `{"tba":694,"total":904,"ratio":0.768}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 360/361 (100%) lots use host 'www.auctionhouse.co.uk' — could be a logo/placeholder
  - `{"host":"www.auctionhouse.co.uk","count":360,"total":361,"ratio":0.997}`

## auctionhousesouthyorkshire

- **[warn] guide_tba_wall** — Guide-TBA wall: 1534/1654 (93%) lots have no price + no price_text
  - `{"tba":1534,"total":1654,"ratio":0.927}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 10 visible addresses appear ≥3 times each (57 rows users can see) — stale re-list rows, URL variants, or venue extraction
  - `{"unique_dupes":10,"total_dupe_rows":57,"examples":[{"address":"sittingbourne - kent","count":12},{"address":"dulverton - somerset","count":11},{"address":"maidstone - kent","count":7}]}`

## countrywide

- **[error] duplicate_address_wall** — Duplicate-address wall: 19 visible addresses appear ≥3 times each (75 rows users can see) — stale re-list rows, URL variants, or venue extraction
  - `{"unique_dupes":19,"total_dupe_rows":75,"examples":[{"address":"poldhu cottage, rectory road, penzance, st. buryan, cornwall, tr19 6bb","count":4},{"address":"51 old exeter road, newton abbot, devon, tq12 2nh","count":4},{"address":"19 st. nicholas street, bodmin, cornwall, pl31 1ab","count":4}]}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 1084/1099 (99%) lots use host 'www.futurepropertyauctions.co.uk' — could be a logo/placeholder
  - `{"host":"www.futurepropertyauctions.co.uk","count":1084,"total":1099,"ratio":0.986}`
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 2329/3143 (74%) lots have no price + no price_text
  - `{"tba":2329,"total":3143,"ratio":0.741}`
- **[warn] image_coverage_low** — Image coverage low: 1924/3143 (61%) lots missing image_url
  - `{"missing":1924,"total":3143,"ratio":0.612}`
