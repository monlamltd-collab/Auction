# Visual Audit — 2026-07-14

Scanned **31,504** rows in **24946ms** across **40** houses with findings.

**Findings:** 19 error · 12 warn · 20 info
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 778/1011 (77%) lots have no price + no price_text
  - `{"tba":778,"total":1011,"ratio":0.77}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 360/364 (99%) lots use host 'www.auctionhouse.co.uk' — could be a logo/placeholder
  - `{"host":"www.auctionhouse.co.uk","count":360,"total":364,"ratio":0.989}`

## auctionhousesouthyorkshire

- **[warn] guide_tba_wall** — Guide-TBA wall: 1535/1606 (96%) lots have no price + no price_text
  - `{"tba":1535,"total":1606,"ratio":0.956}`
...
- **[info] bullet_starvation** — Bullet starvation: 717/902 (79%) lots have empty bullets
  - `{"empty":717,"total":902,"ratio":0.795}`

## buttersjohnbee

- **[error] hero_image_bleed** — Hero-image bleed: 3 distinct addresses share one image_url
  - `{"image_url":"https://s3.eu-west-2.amazonaws.com/app-spoke-sites-qa-uk/134/3d947c64249de3f3e029c5bd31205024.png","distinct_addresses":3}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 1097/1102 (100%) lots use host 'www.futurepropertyauctions.co.uk' — could be a logo/placeholder
  - `{"host":"www.futurepropertyauctions.co.uk","count":1097,"total":1102,"ratio":0.995}`
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 2336/3149 (74%) lots have no price + no price_text
  - `{"tba":2336,"total":3149,"ratio":0.742}`
- **[warn] image_coverage_low** — Image coverage low: 1905/3149 (60%) lots missing image_url
  - `{"missing":1905,"total":3149,"ratio":0.605}`
...
- **hero_image_bleed**: nulled 13 row(s) across 1 house(s).
  - `buttersjohnbee` × 13 — `https://s3.eu-west-2.amazonaws.com/app-spoke-sites-qa-uk/134/3d947c64249de3f3e029c5bd31205024.png`
