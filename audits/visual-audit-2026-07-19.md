# Visual Audit — 2026-07-19

Scanned **32,337** rows in **28063ms** across **40** houses with findings.

**Findings:** 20 error · 12 warn · 19 info
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 780/1020 (76%) lots have no price + no price_text
  - `{"tba":780,"total":1020,"ratio":0.765}`
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 1538/1609 (96%) lots have no price + no price_text
  - `{"tba":1538,"total":1609,"ratio":0.956}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 15 visible addresses appear ≥3 times each (79 rows users can see) — stale re-list rows, URL variants, or venue extraction
  - `{"unique_dupes":15,"total_dupe_rows":79,"examples":[{"address":"sittingbourne - kent","count":11},{"address":"dulverton - somerset","count":12},{"address":"worthing - west sussex","count":3}]}`
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 2338/3161 (74%) lots have no price + no price_text
  - `{"tba":2338,"total":3161,"ratio":0.74}`
- **[warn] image_coverage_low** — Image coverage low: 1868/3161 (59%) lots missing image_url
  - `{"missing":1868,"total":3161,"ratio":0.591}`
