# Visual Audit — 2026-05-30

Scanned **17,434** rows in **9468ms** across **63** houses with findings.

**Findings:** 43 error · 9 warn · 32 info

## acuitus

- **[info] stale_lot_wall** — Stale lot wall: 37/64 (58%) lots are past auction date >7d but still marked available
  - `{"stale":37,"total":64,"ratio":0.578,"cutoff":"2026-05-23T07:35:00.073Z"}`
...
- **[info] bullet_starvation** — Bullet starvation: 59/79 (75%) lots have empty bullets
  - `{"empty":59,"total":79,"ratio":0.747}`
...
- **[info] bullet_starvation** — Bullet starvation: 56/66 (85%) lots have empty bullets
  - `{"empty":56,"total":66,"ratio":0.848}`
...
- **[info] stale_lot_wall** — Stale lot wall: 8/8 (100%) lots are past auction date >7d but still marked available
  - `{"stale":8,"total":8,"ratio":1,"cutoff":"2026-05-23T07:35:00.073Z"}`
