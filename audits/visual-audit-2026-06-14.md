# Visual Audit — 2026-06-14

Scanned **24,628** rows in **14864ms** across **75** houses with findings.

**Findings:** 64 error · 14 warn · 22 info
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 3 addresses appear ≥3 times each (9 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":3,"total_dupe_rows":9,"examples":[{"address":"7e, 7f, 9 & 9a high street, barnet, hertfordshire, en5 5ue","count":3},{"address":"6 enfield road, blackpool, lancashire, fy1 2rb","count":3},{"address":"99 marfleet avenue, hull, east yorkshire, hu9 5sb","count":3}]}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 95/99 (96%) lots use host 'www.auctionhouse.co.uk' — could be a logo/placeholder
  - `{"host":"www.auctionhouse.co.uk","count":95,"total":99,"ratio":0.96}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 59 addresses appear ≥3 times each (182 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":59,"total_dupe_rows":182,"examples":[{"address":"unit 6a-6b south middleton base, greenwell road, aberdeen, ab12 3ax","count":3},{"address":"103 church street, broadstairs, kent, ct10 2tx","count":3},{"address":"34 de montfort road, streatham hill, london, sw16 1lz","count":3}]}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 5 addresses appear ≥3 times each (17 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":5,"total_dupe_rows":17,"examples":[{"address":"flat 25, renaissance house, millbrook street, stockport, sk1 3tn","count":4},{"address":"apartment 12, box apartments, 1 marriott street, stockport, sk1 3pj","count":3},{"address":"flat 34, renaissance house, millbrook street, stockport, sk1 3tn","count":4}]}`
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 305/357 (85%) lots have no price + no price_text
  - `{"tba":305,"total":357,"ratio":0.854}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 255/257 (99%) lots use host 'www.auctionhouse.co.uk' — could be a logo/placeholder
  - `{"host":"www.auctionhouse.co.uk","count":255,"total":257,"ratio":0.992}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 14 addresses appear ≥3 times each (47 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":14,"total_dupe_rows":47,"examples":[{"address":"elizabeth street goldthorpe, rotherham, south yorkshire, s63 9na","count":3},{"address":"land and garage to rear of 12 elizabeth street goldthorpe, rotherham, south yorkshire, s63 9na","count":5},{"address":"plots 51 and 52, land denby line, garden lane, doncaster, south yorkshire, dn5 7sn","count":4}]}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 26 addresses appear ≥3 times each (78 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":26,"total_dupe_rows":78,"examples":[{"address":"10 town hall street, grimsby, north east lincolnshire, dn31 1hn","count":3},{"address":"82 harley road, harlesden, london, nw10 8ax","count":3},{"address":"flat 26 columbus house, the compass, southampton, hampshire, so14 5bq","count":3}]}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 101/111 (91%) lots use host 'www.auctionhouse.co.uk' — could be a logo/placeholder
  - `{"host":"www.auctionhouse.co.uk","count":101,"total":111,"ratio":0.91}`
...
- **[error] hero_image_bleed** — Hero-image bleed: 4 distinct addresses share one image_url
  - `{"image_url":"https://www.maggsandallen.co.uk/images/Maggs,aAllen_Text_Only_WhitePink.png.pagespeed.ce.I-P4uL8KUk.png","distinct_addresses":4}`
- **[warn] image_coverage_low** — Image coverage low: 44/77 (57%) lots missing image_url
  - `{"missing":44,"total":77,"ratio":0.571}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 19 addresses appear ≥3 times each (74 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":19,"total_dupe_rows":74,"examples":[{"address":"634, great horton road bradford, bd7 4aa","count":5},{"address":"10 quebec street bradford, bd1 2er","count":4},{"address":"14, grantham place bradford, bd7 1rj","count":3}]}`
...
- **hero_image_bleed**: nulled 8 row(s) across 1 house(s).
  - `maggsandallen` × 8 — `https://www.maggsandallen.co.uk/images/Maggs,aAllen_Text_Only_WhitePink.png.pagespeed.ce.I-P4uL8KUk.png`
