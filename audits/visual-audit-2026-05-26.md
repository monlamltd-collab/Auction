# Visual Audit — 2026-05-26

Scanned **16,827** rows in **11538ms** across **65** houses with findings.

**Findings:** 40 error · 12 warn · 35 info

## acuitus

- **[info] stale_lot_wall** — Stale lot wall: 37/64 (58%) lots are past auction date >7d but still marked available
  - `{"stale":37,"total":64,"ratio":0.578,"cutoff":"2026-05-19T08:26:08.527Z"}`
...
- **[info] stale_lot_wall** — Stale lot wall: 8/8 (100%) lots are past auction date >7d but still marked available
  - `{"stale":8,"total":8,"ratio":1,"cutoff":"2026-05-19T08:26:08.527Z"}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 8 addresses appear ≥3 times each (25 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":8,"total_dupe_rows":25,"examples":[{"address":"old blairbeg, lamlash, isle of arran","count":3},{"address":"95 catto drive (gff, store and garden), peterhead","count":3},{"address":"565 great western road, first floor, aberdeen","count":3}]}`
- **[info] image_domain_mismatch** — Image domain mismatch: 359/359 (100%) lots use host 'www.futurepropertyauctions.co.uk' — could be a logo/placeholder
  - `{"host":"www.futurepropertyauctions.co.uk","count":359,"total":359,"ratio":1}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 11 addresses appear ≥3 times each (35 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":11,"total_dupe_rows":35,"examples":[{"address":"a split level two bedroom maisonette with glorious sea views over poole harbour","count":3},{"address":"gff 17 quadrant road, thornton heath, surrey, cr7 7db","count":3},{"address":"a spacious 3 double bedroom duplex apartment","count":3}]}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 7 addresses appear ≥3 times each (31 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":7,"total_dupe_rows":31,"examples":[{"address":"bell hill, stapleton, bs16 1bq","count":3},{"address":"3, fountain buildings, bath, ba1 5du","count":5},{"address":"bethel road, st george, bs5 7nn","count":3}]}`
...
- **[warn] image_coverage_low** — Image coverage low: 43/64 (67%) lots missing image_url
  - `{"missing":43,"total":64,"ratio":0.672}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 162 addresses appear ≥3 times each (571 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":162,"total_dupe_rows":571,"examples":[{"address":"418 city point, great homer street, liverpool, liverpool, l5 3le","count":3},{"address":"sunningdale, gull bank, whaplode drove, spalding, lincolnshire, pe12 0ss","count":4},{"address":"flat 2, 9 albert street, penzance, cornwall, tr18 2lr","count":4}]}`
