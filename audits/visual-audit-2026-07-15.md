# Visual Audit — 2026-07-15

Scanned **31,657** rows in **25973ms** across **42** houses with findings.
...
- **[info] image_domain_mismatch** — Image domain mismatch: 78/79 (99%) lots use host 'calpa.upcloudobjects.com' — could be a logo/placeholder
  - `{"host":"calpa.upcloudobjects.com","count":78,"total":79,"ratio":0.987}`
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 780/1013 (77%) lots have no price + no price_text
  - `{"tba":780,"total":1013,"ratio":0.77}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 364/368 (99%) lots use host 'www.auctionhouse.co.uk' — could be a logo/placeholder
  - `{"host":"www.auctionhouse.co.uk","count":364,"total":368,"ratio":0.989}`

## auctionhousesouthyorkshire

- **[warn] guide_tba_wall** — Guide-TBA wall: 1538/1608 (96%) lots have no price + no price_text
  - `{"tba":1538,"total":1608,"ratio":0.956}`
...
- **[info] bullet_starvation** — Bullet starvation: 705/915 (77%) lots have empty bullets
  - `{"empty":705,"total":915,"ratio":0.77}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 11 visible addresses appear ≥3 times each (60 rows users can see) — stale re-list rows, URL variants, or venue extraction
  - `{"unique_dupes":11,"total_dupe_rows":60,"examples":[{"address":"sittingbourne - kent","count":12},{"address":"dulverton - somerset","count":11},{"address":"maidstone - kent","count":7}]}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 1099/1103 (100%) lots use host 'www.futurepropertyauctions.co.uk' — could be a logo/placeholder
  - `{"host":"www.futurepropertyauctions.co.uk","count":1099,"total":1103,"ratio":0.996}`
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 2332/3150 (74%) lots have no price + no price_text
  - `{"tba":2332,"total":3150,"ratio":0.74}`
- **[warn] image_coverage_low** — Image coverage low: 1991/3150 (63%) lots missing image_url
  - `{"missing":1991,"total":3150,"ratio":0.632}`
...
- **[error] hero_image_bleed** — Hero-image bleed: 3 distinct addresses share one image_url
  - `{"image_url":"https://www.suttonkersh.co.uk/properties/details/themes/sk/images/my-sk.png","distinct_addresses":3}`
- **[error] hero_image_bleed** — Hero-image bleed: 5 distinct addresses share one image_url
  - `{"image_url":"https://www.suttonkersh.co.uk/properties/themes/sk/images/my-sk.png","distinct_addresses":5}`
...
- **hero_image_bleed**: nulled 16 row(s) across 1 house(s).
  - `suttonkersh` × 8 — `https://www.suttonkersh.co.uk/properties/details/themes/sk/images/my-sk.png`
  - `suttonkersh` × 8 — `https://www.suttonkersh.co.uk/properties/themes/sk/images/my-sk.png`
