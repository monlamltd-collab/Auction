# Visual Audit — 2026-06-19

Scanned **25,869** rows in **16757ms** across **77** houses with findings.

**Findings:** 66 error · 11 warn · 21 info
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 333/453 (74%) lots have no price + no price_text
  - `{"tba":333,"total":453,"ratio":0.735}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 31 addresses appear ≥3 times each (106 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":31,"total_dupe_rows":106,"examples":[{"address":"5 kilmun court, kilmun, dunoon, argyll and bute pa23 8sf","count":3},{"address":"114 hilltown, dundee, angus dd3 7bg","count":4},{"address":"2g union lane, ellon, aberdeenshire ab41 9ds","count":3}]}`
- **[info] image_domain_mismatch** — Image domain mismatch: 262/265 (99%) lots use host 'www.auctionhouse.co.uk' — could be a logo/placeholder
  - `{"host":"www.auctionhouse.co.uk","count":262,"total":265,"ratio":0.989}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 30 addresses appear ≥3 times each (91 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":30,"total_dupe_rows":91,"examples":[{"address":"flat 1, 22 george street, reading, berkshire, rg1 7nt","count":3},{"address":"81a honley road, catford, london, se6 2hy","count":3},{"address":"17 lonsdale road, blackpool, lancashire, fy1 6ee","count":3}]}`
