# Visual Audit — 2026-05-25

Scanned **16,725** rows in **10949ms** across **63** houses with findings.

**Findings:** 39 error · 16 warn · 34 info

## acuitus

- **[info] stale_lot_wall** — Stale lot wall: 37/64 (58%) lots are past auction date >7d but still marked available
  - `{"stale":37,"total":64,"ratio":0.578,"cutoff":"2026-05-18T08:50:00.987Z"}`
...
- **[info] bullet_starvation** — Bullet starvation: 94/124 (76%) lots have empty bullets
  - `{"empty":94,"total":124,"ratio":0.758}`
...
- **[info] stale_lot_wall** — Stale lot wall: 8/8 (100%) lots are past auction date >7d but still marked available
  - `{"stale":8,"total":8,"ratio":1,"cutoff":"2026-05-18T08:50:00.987Z"}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 339/339 (100%) lots use host 'www.futurepropertyauctions.co.uk' — could be a logo/placeholder
  - `{"host":"www.futurepropertyauctions.co.uk","count":339,"total":339,"ratio":1}`
...
- **[warn] identical_price_wall** — Identical-price wall: 354/580 (61%) lots share price £1500 — extractor likely picking up hero/banner price
  - `{"price":1500,"count":354,"total":580,"ratio":0.61}`
...
- **[warn] image_coverage_low** — Image coverage low: 45/64 (70%) lots missing image_url
  - `{"missing":45,"total":64,"ratio":0.703}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 4 addresses appear ≥3 times each (12 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":4,"total_dupe_rows":12,"examples":[{"address":"3-5 station road, reading, berkshire, rg1 1ld","count":3},{"address":"3 bed semi-detached house","count":3},{"address":"richings way, iver , iver, buckinghamshire, sl0 9da","count":3}]}`
