# Visual Audit — 2026-06-16

Scanned **25,540** rows in **17344ms** across **78** houses with findings.

**Findings:** 65 error · 13 warn · 23 info
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 3 addresses appear ≥3 times each (9 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":3,"total_dupe_rows":9,"examples":[{"address":"7e, 7f, 9 & 9a high street, barnet, hertfordshire, en5 5ue","count":3},{"address":"99 marfleet avenue, hull, east yorkshire, hu9 5sb","count":3},{"address":"6 enfield road, blackpool, lancashire, fy1 2rb","count":3}]}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 95/100 (95%) lots use host 'www.auctionhouse.co.uk' — could be a logo/placeholder
  - `{"host":"www.auctionhouse.co.uk","count":95,"total":100,"ratio":0.95}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 3 addresses appear ≥3 times each (10 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":3,"total_dupe_rows":10,"examples":[{"address":"39 stonegate, spalding, lincolnshire pe11 2ph","count":3},{"address":"rockys bar and restaurant, king george v playing field, chequers lane, papworth everard, cambridgeshire cb23 3qq","count":3},{"address":"103 gloucester street, norwich, norfolk nr2 2dy","count":4}]}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 59 addresses appear ≥3 times each (193 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":59,"total_dupe_rows":193,"examples":[{"address":"45 cundalls road, ware, hertfordshire, sg12 7dh","count":4},{"address":"30b fernshaw road, chelsea, london, sw10 0tf","count":3},{"address":"103 church street, broadstairs, kent, ct10 2tx","count":3}]}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 5 addresses appear ≥3 times each (17 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":5,"total_dupe_rows":17,"examples":[{"address":"flat 34, renaissance house, millbrook street, stockport, sk1 3tn","count":4},{"address":"flat 25, renaissance house, millbrook street, stockport, sk1 3tn","count":4},{"address":"apartment 12, box apartments, 1 marriott street, stockport, sk1 3pj","count":3}]}`
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 305/359 (85%) lots have no price + no price_text
  - `{"tba":305,"total":359,"ratio":0.85}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 4 addresses appear ≥3 times each (12 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":4,"total_dupe_rows":12,"examples":[{"address":"88 sherbourne road, blackpool, lancashire fy1 2pq","count":3},{"address":"apartment 305, the litmus building, 195 huntingdon street, nottingham, nottinghamshire ng1 3nt","count":3},{"address":"7 grosvenor gardens, 513 radcliffe road, bolton, greater manchester bl3 1sh","count":3}]}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 258/259 (100%) lots use host 'www.auctionhouse.co.uk' — could be a logo/placeholder
  - `{"host":"www.auctionhouse.co.uk","count":258,"total":259,"ratio":0.996}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 14 addresses appear ≥3 times each (47 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":14,"total_dupe_rows":47,"examples":[{"address":"plots 28 and 30, land denby line, garden lane, doncaster, south yorkshire, dn5 7sn","count":4},{"address":"apartment 54 stone gate house, bradford, west yorkshire, bd1 4qf","count":3},{"address":"38 victoria street goldthorpe, rotherham, south yorkshire, s63 9hs","count":4}]}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 26 addresses appear ≥3 times each (78 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":26,"total_dupe_rows":78,"examples":[{"address":"81a honley road, catford, london, se6 2hy","count":3},{"address":"10 town hall street, grimsby, north east lincolnshire, dn31 1hn","count":3},{"address":"82 harley road, harlesden, london, nw10 8ax","count":3}]}`

## auctionhousewales

- **[warn] guide_tba_wall** — Guide-TBA wall: 219/293 (75%) lots have no price + no price_text
  - `{"tba":219,"total":293,"ratio":0.747}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 4 addresses appear ≥3 times each (13 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":4,"total_dupe_rows":13,"examples":[{"address":"flat 3, 40 tivoli crescent, brighton, bn1 5nd","count":3},{"address":"flat 6, 192 church road, hove, bn3 2dj","count":4},{"address":"53 dominica court, eastbourne, bn23 5tr","count":3}]}`
- **[info] image_domain_mismatch** — Image domain mismatch: 102/112 (91%) lots use host 'www.auctionhouse.co.uk' — could be a logo/placeholder
  - `{"host":"www.auctionhouse.co.uk","count":102,"total":112,"ratio":0.911}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 447/448 (100%) lots use host 'www.futurepropertyauctions.co.uk' — could be a logo/placeholder
  - `{"host":"www.futurepropertyauctions.co.uk","count":447,"total":448,"ratio":0.998}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 2 addresses appear ≥3 times each (7 total dupe rows) — pagination may be looping page 1
  - `{"unique_dupes":2,"total_dupe_rows":7,"examples":[{"address":"the knot barn, 1 station road, padstow, cornwall, pl28 8db","count":4},{"address":"51 margravine road, london, w6 8ll","count":3}]}`
