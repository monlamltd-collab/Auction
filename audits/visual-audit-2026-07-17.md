# Visual Audit — 2026-07-17

Scanned **32,197** rows in **26272ms** across **39** houses with findings.

**Findings:** 19 error · 12 warn · 19 info

## ahlondon

- **[warn] identical_price_wall** — Identical-price wall: 120/206 (58%) lots share price £1800 — extractor likely picking up hero/banner price
  - `{"price":1800,"count":120,"total":206,"ratio":0.583}`
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 780/1016 (77%) lots have no price + no price_text
  - `{"tba":780,"total":1016,"ratio":0.768}`
...
- **[info] bullet_starvation** — Bullet starvation: 725/935 (78%) lots have empty bullets
  - `{"empty":725,"total":935,"ratio":0.775}`
...
- **[error] duplicate_address_wall** — Duplicate-address wall: 12 visible addresses appear ≥3 times each (63 rows users can see) — stale re-list rows, URL variants, or venue extraction
  - `{"unique_dupes":12,"total_dupe_rows":63,"examples":[{"address":"sittingbourne - kent","count":10},{"address":"dulverton - somerset","count":11},{"address":"maidstone - kent","count":7}]}`
...
- **[info] image_domain_mismatch** — Image domain mismatch: 1129/1130 (100%) lots use host 'www.futurepropertyauctions.co.uk' — could be a logo/placeholder
  - `{"host":"www.futurepropertyauctions.co.uk","count":1129,"total":1130,"ratio":0.999}`
...
- **[warn] guide_tba_wall** — Guide-TBA wall: 2337/3160 (74%) lots have no price + no price_text
  - `{"tba":2337,"total":3160,"ratio":0.74}`
- **[warn] image_coverage_low** — Image coverage low: 1924/3160 (61%) lots missing image_url
  - `{"missing":1924,"total":3160,"ratio":0.609}`
...
- **[error] hero_image_bleed** — Hero-image bleed: 3 distinct addresses share one image_url
  - `{"image_url":"https://www.wilsonsauctions.com/assets/iso.webp","distinct_addresses":3}`


## Auto-fixes applied

- **hero_image_bleed**: nulled 4 row(s) across 1 house(s).
  - `wilsons` × 4 — `https://www.wilsonsauctions.com/assets/iso.webp`
