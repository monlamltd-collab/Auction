#!/bin/bash
# loop-detail.sh — Ralph Wiggum loop for Detail Pages Agent

MISSION_FILE="bridgematch-agents/missions/mission-detail.md"
LOG_FILE="bugs/bugs-detail.md"
AGENT_NAME="DETAIL"
...
if [ ! -f "$LOG_FILE" ]; then
  echo "# BridgeMatch Bug Log — Detail Pages Agent" > "$LOG_FILE"
